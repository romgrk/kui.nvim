...
import type { BackgroundSystem, ICanvas, IRenderableObject, IRenderer, IRendererOptions, IRendererRenderOptions, Rectangle, StartupSystem, ViewSystem } from 'src/core';
 ...
 * @memberof PIXI
 */
export declare class CanvasRenderer extends SystemManager<CanvasRenderer> implements IRenderer<any> {
    /**
