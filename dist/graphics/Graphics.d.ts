import { BLEND_MODES, Matrix, Point, Polygon } from 'src/core';
...
import type { SCALE_MODES } from 'src/core';
...
export declare class Graphics extends Container {
     ...
     */
    lineStyle(options: ILineStyleOptions | number): this;
    /**
    ...
    */
    generateCanvasTexture(scaleMode?: SCALE_MODES, resolution?: number): any;
    cachedGraphicsData: never[];
    /**
