import { BatchDrawCall, BatchGeometry } from 'src/core';
import { Bounds } from 'src/display';
import { GraphicsData } from './GraphicsData';
import { BatchPart } from './utils';
import type { Circle, Ellipse, IPointData, Matrix, Polygon, Rectangle, RoundedRectangle } from 'src/math';
...
export declare class GraphicsGeometry extends BatchGeometry {
     ...
     * when calculating bounds for the graphics geometry. See PR [#8343]{_link https://github.com/pixijs/pixijs/pull/8343}
     * and issue [#8623]{_link https://github.com/pixijs/pixijs/pull/8623}.
     * @readonly
     */
    get bounds(): Bounds;
     ...
     */
    drawShape(shape: IShape, fillStyle?: FillStyle | null, lineStyle?: LineStyle | null, matrix?: Matrix | null): GraphicsGeometry;
    /**
     * Draws the given shape to this Graphics object. Can be any of Circle, Rectangle, Ellipse, Line or Polygon.
     * @param {PIXI.Circle|PIXI.Ellipse|PIXI.Polygon|PIXI.Rectangle|PIXI.RoundedRectangle} shape - The shape object to draw.
     * @param matrix - Transform applied to the points of the shape.
     * @returns - Returns geometry for chaining.
     */
    drawHole(shape: IShape, matrix?: Matrix | null): GraphicsGeometry | null;
     ...
     * @param styleB
     */
    protected _compareStyles(styleA: FillStyle | LineStyle | null, styleB: FillStyle | LineStyle | null): boolean;
