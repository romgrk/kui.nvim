...
export class GraphicsGeometry extends BatchGeometry
{
    ...
    uvsFloat32: Float32Array | null = null;
    indicesUint16: Uint16Array | Uint32Array | null = null;
    batchable = false;
    ...
    public drawShape(
        ...
        matrix: Matrix | null = null): GraphicsGeometry
    {
     ...
     * @returns - Returns geometry for chaining.
     */
    public drawHole(shape: IShape, matrix: Matrix | null = null): GraphicsGeometry | null
    {
    ...
    public destroy(): void
    {
        ...
        this.graphicsData.length = 0;
        this.graphicsData = null as any;
        this.drawCalls.length = 0;
        this.drawCalls = null as any;
        this.batches.length = 0;
    ...
    protected _compareStyles(
        styleA: FillStyle | LineStyle | null,
        styleB: FillStyle | LineStyle | null
    ): boolean
    {
        if (!styleA || !styleB)
        {
