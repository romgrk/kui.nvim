...
export interface Graphics extends Container {}
...
export class Graphics extends Container
{
    ...
    protected vertexData: Float32Array | null = null;
     ...
     */
    public lineStyle(options: ILineStyleOptions | number): this;

    public lineStyle(options: ILineStyleOptions | number,
    ...
    beginTextureFill(options?: IFillStyleOptions): this
    {
        ...
        const visible = options.alpha && options.alpha > 0;
    ...
    * or the **src/canvas-graphics** package.
    ...
    */
    generateCanvasTexture(scaleMode?: SCALE_MODES, resolution = 1): any // Texture
    {
        throw new Error('generateCanvasTexture unimplemented')
    ...
    */
    _renderCanvas(renderer: CanvasRenderer): void
    {
        ...
        this.finishPoly();
        renderer.get<CanvasGraphicsRenderer>('graphics').render(this);
    };
    ...
    public destroy(options?: IDestroyOptions | boolean): void
    {
        ...
        this._lineStyle = null as any;
        this._fillStyle.destroy();
        this._fillStyle = null as any;
        this._geometry = null as any;
        this.vertexData = null;
        this.batches.length = 0;
        this.batches = null as any;
