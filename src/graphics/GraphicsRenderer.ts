...
import type { Circle, Ellipse, Polygon, Rectangle, RoundedRectangle } from 'src/math';
import type { FillStyle, Graphics, GraphicsData, LineStyle } from 'src/graphics';
 ...
 * @memberof PIXI
 */
export class CanvasGraphicsRenderer implements ISystem
{
    static systemName = 'graphics'

    /** A reference to the current renderer */
    public renderer: CanvasRenderer;
    // private _svgMatrix: DOMMatrix | boolean | null = null;
     ...
     */
    private _calcCanvasStyle(style: FillStyle, tint: number): string
    {
        let res;
    ...
    public render(graphics: Graphics): void
    {
        ...
        let contextFillStyle: string;
        let contextStrokeStyle: string;
    ...
    private paintPolygonStroke(
        shape: Polygon,
        lineStyle: LineStyle,
        contextStrokeStyle: string,
        holes: GraphicsData[],
        holesDirection: boolean[],
        worldAlpha: number,
    ...
    public destroy(): void
    {
        ...
        this._tempMatrix = null as any;
    }
}

systems.register('graphics', CanvasGraphicsRenderer)
