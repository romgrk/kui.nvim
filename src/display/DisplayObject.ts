...
export abstract class DisplayObject extends EventEmitter<DisplayObjectEvents>
{
     ...
     */
    public cullArea: Rectangle | null;
    ...
    public _localBounds: Bounds | null;
    ...
    private tempDisplayObjectParent: TemporaryDisplayObject | null;
    ...
    constructor()
    {
        ...
        this.displayObjectUpdateTransform = DisplayObject.prototype.updateTransform
    }
    ...
    {
        let item = this as DisplayObject | null;
...
export class TemporaryDisplayObject extends DisplayObject
{
    ...
    constructor() {
        super()
        this.calculateBounds = noop as any
        this.removeChild = noop as any
        this.render = noop as any
        this.renderCanvas = noop as any
    }
}
