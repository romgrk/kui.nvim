...
export class Geometry
{
    ...
    interleave(): Geometry
    {
        ...
        const arrays = [];
        const sizes = [];
        const interleavedBuffer = new Buffer(null);
        let i;
