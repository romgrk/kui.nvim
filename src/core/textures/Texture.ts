import { Point, Rectangle } from 'src/math';
import { settings } from 'src/settings';
import { EventEmitter, TextureCache, uid } from 'src/utils';
import { BaseTexture } from './BaseTexture';
// import { ImageResource } from './resources/ImageResource';
import { TextureUvs } from './TextureUvs';

import type { IPointData, ISize } from 'src/math';
...
export interface Texture extends EventEmitter {}
...
export class Texture<R extends Resource = Resource> extends EventEmitter
{
    ...
    public uvMatrix: TextureMatrix | null;
     ...
     * @param rotate - indicates how the texture was rotated by texture packer. See {_link PIXI.groupD8}
    ...
    update(): void
    {
        if (this.baseTexture?.resource !== null)
        {
    ...
    destroy(destroyBase?: boolean): void
    {
        ...
        this._frame = null as any;
        this._uvs = null as any;
        this.trim = null;
        this.orig = null as any;

        this.valid = false;

        Texture.removeFromCache(this);
        this.textureCacheIds = null as any;
    }
    ...
    clone(): Texture
    {
        ...
        const clonedTexture = new Texture(this.baseTexture,
            !this.noFrame ? clonedFrame : undefined,
            clonedOrig,
            this.trim?.clone(),
            this.rotate,
            this.defaultAnchor
        ...
        url: string | string[], options?: IBaseTextureOptions<RO>): Promise<Texture<R>>
    {
        ...
        const texture = Texture.from<R>(url, Object.assign({ resourceOptions }, options));
    ...
    static removeFromCache(texture: string | Texture): Texture | null
    {
        ...
        else if (texture?.textureCacheIds !== undefined)
        {
    ...
    set frame(frame: Rectangle)
    {
        ...
        this.valid = Boolean(width && height && this.baseTexture.valid);
     ...
     * See {_link PIXI.groupD8} for explanation
     */
    get rotate(): number
    {
        return this._rotate;
