...
import { BaseTextureCache, EventEmitter, isPow2, TextureCache, uid } from 'src/utils';
 ...
 */
export class BaseTexture<R extends Resource = Resource, RO = any> extends EventEmitter
{
    /**
    ...
    private _mipmap: MIPMAP_MODES | null;
    private _scaleMode: SCALE_MODES | null;
    private _wrapMode: WRAP_MODES | null;
    ...
    constructor(
        ...
        options: IBaseTextureOptions<RO> | null = null
    )
    {
        super();
    ...
    */
    ...
    static removeFromCache(baseTexture: string | BaseTexture): BaseTexture | null
    {
        ...
        else if (baseTexture?.textureCacheIds !== null)
        {
