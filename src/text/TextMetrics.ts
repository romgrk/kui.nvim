import { settings } from 'src/core';
import { Canvas } from 'src/context2d'

import type { ICanvas, ICanvasRenderingContext2D } from 'src/core';
...
export class TextMetrics
{
    ...
    public static get experimentalLetterSpacingSupported(): boolean
    {
        ...
        if (result === undefined)
        {
            ...
            result
                ...
                = ('letterSpacing' in proto || 'textLetterSpacing' in proto) ?? false;
        }
    ...
    ): TextMetrics
    {
        ...
        const lines = vim.split(outputText, '\n');
        const lineWidths = [] as number[];
        let maxLineWidth = 0;
    ...
    public static measureFont(font: string): IFontMetrics
    {
        ...
        const extents = context.getFontExtents()

        const properties: IFontMetrics = {
            ascent: extents.ascent,
            descent: extents.descent,
            fontSize: extents.ascent + extents.descent,
        };
    ...
    public static get _canvas(): ICanvas
    {
        ...
        {
            TextMetrics.__canvas = new Canvas(10, 10);
        }
