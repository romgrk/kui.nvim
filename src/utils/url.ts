...
const _format = () => { throw new Error('unimplemented') }
const _parse = () => { throw new Error('unimplemented') }
const _resolve = () => { throw new Error('unimplemented') }
...
type FormatFunction = {
    (url: any, options?: URLFormatOptions): string;
